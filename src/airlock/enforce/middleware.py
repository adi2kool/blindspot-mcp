...
from airlock.provenance.integrity import verify, verify_signature
from airlock.sanitize import strip_invisible

logger = logging.getLogger("airlock.enforce")
...
def _redaction(reason: str) -> str:
    return f"[content quarantined by airlock enforcer: {reason}]"
