...
Config via environment:
  BLINDSPOT_JUDGE       on | off | auto   (default auto)
  BLINDSPOT_JUDGE_MODEL model tag          (default llama3.2)
  BLINDSPOT_JUDGE_URL   base url           (default http://localhost:11434)
"""
...
from blindspot.models import AttackClass, Finding, ScanTarget, Severity
...
class Judge:
    ...
    def __init__(
        ...
        self.mode = (mode or os.environ.get("BLINDSPOT_JUDGE", "auto")).lower()
        self.model = model or os.environ.get("BLINDSPOT_JUDGE_MODEL", "llama3.2")
        self.base_url = (base_url or os.environ.get("BLINDSPOT_JUDGE_URL", "http://localhost:11434")).rstrip("/")
    ...
    def _to_findings(self, data: dict, target: ScanTarget) -> list[Finding]:
        ...
        for item in data.get("findings", []):
            ...
            if evidence:
                ...
                if idx >= 0:
                    from blindspot.models import Span
