...
from blindspot.models import AttackClass, Finding, Severity, Span, severity_rank
...
from blindspot.sanitize import TAG_END as _TAG_END
from blindspot.sanitize import TAG_START as _TAG_START
from blindspot.sanitize import _is_strippable_invisible, strip_invisible
...
def _dedupe(findings: list[Finding]) -> list[Finding]:
    ...
    from blindspot.models import severity_rank
